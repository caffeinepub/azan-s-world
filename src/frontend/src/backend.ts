...
import type { ExternalBlob as _ExternalBlob, UserRole as _UserRole, Video as _Video, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createVideo(arg0: string, arg1: string, arg2: ExternalBlob, arg3: ExternalBlob, arg4: string, arg5: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createVideo(arg0, arg1, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg2), await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg3), arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterByCategory(arg0: string): Promise<Array<[Video, bigint, bigint]>> {
        if (this.processError) {
            try {
    ...
    async getVideo(arg0: bigint): Promise<[Video, bigint, bigint]> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideo(arg0);
                return [
                    from_candid_Video_n13(this._uploadFile, this._downloadFile, result[0]),
                    result[1],
                    result[2]
                ];
            } catch (e) {
    ...
    async listVideos(): Promise<Array<[Video, bigint, bigint]>> {
        if (this.processError) {
            try {
    ...
    async searchVideos(arg0: string): Promise<Array<[Video, bigint, bigint]>> {
        if (this.processError) {
            try {
    ...
    async updateVideo(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: Array<string>): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        videoBlob: await from_candid_ExternalBlob_n15(_uploadFile, _downloadFile, value.videoBlob),
        thumbnailBlob: await from_candid_ExternalBlob_n15(_uploadFile, _downloadFile, value.thumbnailBlob),
...
async function from_candid_tuple_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [_Video, bigint, bigint]): Promise<[Video, bigint, bigint]> {
    return [
        await from_candid_Video_n13(_uploadFile, _downloadFile, value[0]),
        value[1],
        value[2]
    ];
}
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[_Video, bigint, bigint]>): Promise<Array<[Video, bigint, bigint]>> {
