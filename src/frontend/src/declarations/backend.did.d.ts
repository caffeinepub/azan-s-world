...
export interface _SERVICE {
  ...
  'createVideo' : ActorMethod<
    [string, string, ExternalBlob, ExternalBlob, string, Array<string>],
    bigint
  >,
  'deleteVideo' : ActorMethod<[bigint], undefined>,
  'filterByCategory' : ActorMethod<[string], Array<[Video, bigint, bigint]>>,
  'getCallerUserRole' : ActorMethod<[], UserRole>,
  'getComments' : ActorMethod<[bigint], Array<Comment>>,
  'getVideo' : ActorMethod<[bigint], [Video, bigint, bigint]>,
  'incrementViewCount' : ActorMethod<[bigint], undefined>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'likeVideo' : ActorMethod<[bigint], undefined>,
  'listVideos' : ActorMethod<[], Array<[Video, bigint, bigint]>>,
  'searchVideos' : ActorMethod<[string], Array<[Video, bigint, bigint]>>,
